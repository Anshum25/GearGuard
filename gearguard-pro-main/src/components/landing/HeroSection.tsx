...
import { ArrowRight, Play, Monitor, Settings, Calendar, Users } from "lucide-react";
              ...
              >
                ...
                <div className="p-6 bg-gradient-to-br from-background to-muted/30">
                  ...
                  <div className="grid grid-cols-3 gap-4 mb-6">
                    {[
                      { icon: Settings, label: "Equipment", value: "248", color: "primary" },
                      { icon: Calendar, label: "Scheduled", value: "12", color: "accent" },
                      { icon: Users, label: "Technicians", value: "24", color: "success" },
                    ].map((item, index) => (
                      <div key={index} className="bg-card rounded-xl p-4 border border-border">
                        <div className={`w-8 h-8 rounded-lg bg-${item.color}/10 flex items-center justify-center mb-2`}>
                      ...
                      <div key={status} className="bg-muted/50 rounded-lg p-3">
                        ...
                        <div className="space-y-2">
                          {Array.from({ length: Math.max(1, 3 - index) }).map((_, i) => (
                            <div key={i} className="bg-card rounded-md p-2 shadow-sm border border-border">
