...
import { Layers, Shield, Settings, Building2 } from "lucide-react";
...
const BuiltForOdooSection = () => {
  const ref = useRef(null);
  const isInView = useInView(ref, { once: true, margin: "-100px" });

  return (
    <section className="py-24 bg-muted/30 relative overflow-hidden">
      {/* Background decoration - Odoo-style */}
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-heading font-bold text-foreground mb-6">
              Designed for the{" "}
              <span className="gradient-text">Odoo Ecosystem</span>
            </h2>
            <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
              GearGuard isn't just compatible with Odoo—it's built from the ground up to feel like 
              a native part of your ERP. Same UI patterns, same user permissions, same data model philosophy.
            </p>
...
export default BuiltForOdooSection;