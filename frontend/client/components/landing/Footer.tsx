...
import { Github, Linkedin, Settings, Twitter } from "lucide-react";
            ...
            <div className="container mx-auto px-4 relative z-10">
                <div className="grid md:grid-cols-4 gap-12 mb-12">
                    <div className="md:col-span-2">
                        ...
                        >
                            The Ultimate Maintenance Tracker for Odoo. Smarter maintenance, zero downtime, complete visibility across
                ...
                >
                    <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                        <p className="text-background/50 text-sm">© {currentYear} GearGuard. All rights reserved.</p>
